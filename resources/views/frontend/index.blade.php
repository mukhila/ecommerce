                    ...
                    <div class="slide-3 no-arrow slick-default-margin">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('frontassets/images/fashion-1/blog/1.png') }}"
                            ...
                            <div class="blog-details">
                                ...
                                <a href="#!">
                                    <p>Top 10 January Best-Sellers Products – All Under ₹3500!</p>
                                </a>
                                <hr class="style1">
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('frontassets/images/fashion-1/blog/2.png') }}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('frontassets/images/fashion-1/blog/3.png') }}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset('frontassets/images/fashion-1/instagram/1.png') }}"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset('frontassets/images/fashion-1/instagram/2.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset('frontassets/images/fashion-1/instagram/3.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset('frontassets/images/fashion-1/instagram/4.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset('frontassets/images/fashion-1/instagram/5.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset('frontassets/images/fashion-1/instagram/6.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset('frontassets/images/fashion-1/instagram/7.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                    ...
                    <div class="slide-6 no-arrow">
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/1.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/2.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/3.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/4.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/5.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/6.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/7.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset('frontassets/images/logos/8.png') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>

            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-text">
                        ...
                        <p class="mb-4">By accessing this website, we assume you accept these terms and conditions. Do not continue to use Jango Kidswear if you do not agree to take all of the terms and conditions stated on this page.</p>
                        ...
                        <p class="mb-4">Unless otherwise stated, Jango Kidswear and/or its licensors own the intellectual property rights for all material on Jango Kidswear. All intellectual property rights are reserved. You may access this for your own personal use subjected to restrictions set in these terms and conditions.</p>

                        <h4 class="mb-3">6. Limitation of Liability</h4>
                        <p class="mb-0">In no event shall Jango Kidswear, nor any of its officers, directors and employees, be held liable for anything arising out of or in any way connected with your use of this website. Jango Kidswear, including its officers, directors and employees shall not be held liable for any indirect, consequential or special liability arising out of or in any way related to your use of this website.</p>
                    </div>
                </div>
            </div>
        </div>

...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Create Attribute Value</h4>
                ...
                <form action="{{ route('admin.attribute_values.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="value" name="value" value="{{ old('value') }}" placeholder="Enter value (e.g. S, M, L, Cotton)" required>
                        @error('value')
                             <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>

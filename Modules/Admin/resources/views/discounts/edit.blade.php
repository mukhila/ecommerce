...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Edit Discount</h4>
                ...
                <form action="{{ route('admin.discounts.update', $discount->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $discount->name) }}" placeholder="e.g. Summer Sale" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                             ...
                             <input type="number" step="0.01" class="form-control" id="value" name="value" value="{{ old('value', $discount->value) }}" placeholder="e.g. 15" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <input type="checkbox" class="form-check-input" id="status" name="status" value="1" {{ old('status', $discount->status) ? 'checked' : '' }}>

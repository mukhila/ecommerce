...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Create {{ ucfirst($type) }} Menu</h4>
                ...
                <form action="{{ route('admin.menus.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="url" name="url" value="{{ old('url') }}" placeholder="e.g., /about-us or http://example.com">
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.menus.index', ['type' => $type]) }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
